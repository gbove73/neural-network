package it.bove;
    ...
    public class NeuralNetwork {
        ...
        public NeuralNetwork(int inputSize, int hiddenSize, int outputSize, double learningRate, double dropoutRate) {
            log.debug("Creazione di una nuova rete neurale con {} neuroni di input, {} neuroni nascosti, {} neuroni di output, tasso di apprendimento {} e tasso di dropout {}",
                    inputSize, hiddenSize, outputSize, learningRate, dropoutRate);
